...
const HeroSection = () => {
  return (
    <Flex justify='center' className='border-b border-neutral-900 pb-4 w-full'>
      <Flex wrap='wrap'>
        ...
        <Flex wrap='wrap' className='w-full lg:w-1/2 items-center lg:items-start justify-center lg:justify-end pb-6'>
          <Flex wrap='wrap' justify='center' direction='column' align='center' className='items-center'>
            <Heading as='h2' className='pt-6 pb-10 text-4xl font-thin tracking-tight lg:mt-16 lg:text-6xl'>Skills</Heading>
