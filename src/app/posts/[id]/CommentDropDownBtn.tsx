...
const CommentDropDownBtn = ({ commentId }: { commentId: string }) => {
      ...
      <AlertDialog.Root>
        ...
        <AlertDialog.Content>
          ...
          <Flex gap="3" mt="4" justify="end">
            ...
            <AlertDialog.Action>
              <Button variant="solid" color="tomato" disabled={isLoading} onClick={deleteComment} className='hover:cursor-pointer'>
                Delete Comment
              </Button>
            </AlertDialog.Action>
          </Flex>
